...
# Quita a pedro de deep
empleados_deep.remove(empleados_deep[0])

print("----- empleados original ------")
print(empleados)
# [['Pedro', ['Python', 'SQL', 'Testing', 'Bash']], ['Manolo', ['Java', 'C++', 'JavaScript']], ['Alejandro', ['HTML', 'CSS', 'JavaScript']]]
print()
...
# [['Manolo', ['Java', 'C++', 'JavaScript']], ['Alejandro', ['HTML', 'CSS', 'JavaScript', 'Java']], ['Juan', ['Node.js', 'redis']]]
