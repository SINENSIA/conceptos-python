...
with open('mi_archivo.txt', 'r', encoding='UTF-8') as file:
    while True:
        ...
        # Print simpre añade un salto de linea, lo omitimos con end=''
        print(line, end='')


# Abre el archivo en modo de escritura ('w') y crea una nueva línea de texto.
with open('mi_archivo.txt', 'w', encoding='UTF-8') as file:
